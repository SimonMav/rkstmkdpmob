...
public class MeineFunktionenActivity extends AppCompatActivity
    ...
    public void highlightBulletinMenuItem(){
        ...
        navigationView.getMenu()
                .findItem(R.id.nav_functions)  //change this to current menu id!
                .getIcon()
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mWebView.loadUrl("https://dienstplan.st.roteskreuz.at/Home/MeineFunktionen"); //Lad die aktuelle Seite
